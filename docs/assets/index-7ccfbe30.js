 ...
 */const Et="important",$e=" !"+Et,ye=me(class extends be{constructor(e){var t;if(super(e),e.type!==ge.ATTRIBUTE||e.name!=="style"||((t=e.strings)===null||t===void 0?void 0:t.length)>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce((t,i)=>{const a=e[i];return a==null?t:t+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${a};`},"")}update(e,[t]){const{style:i}=e.element;if(this.ht===void 0){this.ht=new Set;for(const a in t)this.ht.add(a);return this.render(t)}this.ht.forEach(a=>{t[a]==null&&(this.ht.delete(a),a.includes("-")?i.removeProperty(a):i[a]="")});for(const a in t){const n=t[a];if(n!=null){this.ht.add(a);const r=typeof n=="string"&&n.endsWith($e);a.includes("-")||r?i.setProperty(a,r?n.slice(0,-11):n,r?Et:""):i[a]=n}}return L}});function l(e){const{vertices:t,size:i,fill:a,label:n,transforms:r,children:s=!1}=e;return we({children:s,vertices:t,size:i,fill:a,label:n,transforms:r})}let Tt=function(e){return Math.PI*e/180},Ce=function(e,t,i){return i+e*Math.cos(Tt(t))},Ae=function(e,t,i){return i+e*Math.sin(Tt(t))},pt=function(e){return e<1e-7?0:e};const we=e=>{let t=e.size||96,i=t/2,a=1*t/2,n=360/e.vertices,r=90,s=e.fill||"red",u=[0,0,t,t].join(" ");const p=[function(f){for(var h=[],m=0;m<f;m++){var w=n*m-r,z=[m===0?"M":"L",pt(Ce(a,w,i)),pt(Ae(a,w,i))].join(" ");h.push(z)}return h.join(" ")}(e.vertices)].join(" ");return e.children?o`
        ...
        `:o` ${Y(t,u,s,p,e.transforms)} `};function Y(e,t,i,a,n){let r={pointerEvents:"none",transformOrigin:"center",transform:`${n??""}`};return C`<svg
    viewBox=${t}
    width=${e}
    height=${e}
    fill=${i}
  ...
  >
    <path d=${a} />
  </svg>`}function Ot(e=100){return l({vertices:22,size:e,fill:"currentColor"})}function It(){return o`<h2 class="headline" />`}function d(e=1,t){return o` ${[...Array(e)].map(i=>o`<p class="text ${t?"text-short":""}" />`)}`}function J(){return o` <button>${d()}</button> `}function xe(e){return{form:{vertices:5},utils:{vertices:7},media:{vertices:6},theme:{vertices:3},group:{vertices:4}}[e]}function vt(e){const t=document.querySelector(e);t instanceof HTMLElement&&(t.innerHTML="")}function _(e){return document.querySelector(e)}const Se=["chevronLeft","chevronRight","chevronDown","chevronUp","caretLeft","caretRight","caretDown","caretUp","arrowDown","arrowUp","slash","handle","check","cross","plus","dotsY","dotsX","minus","heart","bookmark","pin","star"];function _e(){return o`
        ...
        >
            ${Se.map(e=>o`${kt({d:e,label:e,size:48})}`)}
        </div>
    ...
    `}function kt({d:e,size:t,label:i}){return C`<svg
      width="${t}px"
      height="${t}px"
      focusable="false"
      data-icon
  ...
  `}function Ee(e){E(Te(e),document.querySelector("article"))}function Te(e){const{label:t,snippets:i}=e;return o`
        <ul
            id="snippets-list"
            role="list"
            aria-label=${t}
    ...
    `}function Oe(e){const{value:t,label:i,kind:a,description:n}=e,{kind:r}=g.getState(),s=u=>{if(r!==u){A(g,"SET_KIND",u);const c=Q.filter(p=>p.kind===u);A(g,"FILTERED",c)}else A(g,"SET_KIND",void 0),A(g,"FILTERED",Q)};return t===""?o`
        ...
        <div data-list-item-end="">
            <a href=${`?snippet=${t}`}>
                ${kt({d:"chevronRight",size:42,label:"Ico label"})}</a
            >
        </div>
    </li>`}function Ie(){return document.body.addEventListener("click",e=>{const t=_("[data-actionsheet]"),i=t.dataset.actionsheetOpen==="true";e.target.id!=="show-tray"&&e.target.id!=="clear-input"&&(e.target.id==="show-sheet"?i?(t.dataset.actionsheetOpen="false",t.querySelector("[data-actionsheet-snap-sentinel]").scrollIntoView({behavior:"smooth"})):(t.querySelector("[data-actionsheet-menu]:first-of-type").scrollIntoView({behavior:"smooth"}),t.dataset.actionsheetOpen="true"):i&&(t.dataset.actionsheetOpen="false",t.querySelector("[data-actionsheet-snap-sentinel]").scrollIntoView({behavior:"smooth"})))}),o` ${d(5)}
    ...
    ${d(3)}
            <div data-group="flex" data-gap="xl" data-flex-wrap>
                ...
                <a href="javascript:;" data-button="stretch" aria-label="Rate four stars"
                    >${C`<svg  width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
    ...
    `}function Le(){return o`
        ...
        <div data-group="flex" data-flex="column" data-gap="sm">
            ...
            <div data-input="">
                ${C`<svg data-input-start="" width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M1.35248 4.90532C1.35248 2.94498 2.936 1.35248 4.89346 1.35248C6.25769 1.35248 6.86058 1.92336 7.50002 2.93545C8.13946 1.92336 8.74235 1.35248 10.1066 1.35248C12.064 1.35248 13.6476 2.94498 13.6476 4.90532C13.6476 6.74041 12.6013 8.50508 11.4008 9.96927C10.2636 11.3562 8.92194 12.5508 8.00601 13.3664C7.94645 13.4194 7.88869 13.4709 7.83291 13.5206C7.64324 13.6899 7.3568 13.6899 7.16713 13.5206C7.11135 13.4709 7.05359 13.4194 6.99403 13.3664C6.0781 12.5508 4.73641 11.3562 3.59926 9.96927C2.39872 8.50508 1.35248 6.74041 1.35248 4.90532Z"
                    fill="currentColor"
                    fillRule="evenodd"
            ...
            <div data-input="">
                <input
                    ...
                    placeholder="Write..."
                />
                ${C`<svg data-input-end="" width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M1.35248 4.90532C1.35248 2.94498 2.936 1.35248 4.89346 1.35248C6.25769 1.35248 6.86058 1.92336 7.50002 2.93545C8.13946 1.92336 8.74235 1.35248 10.1066 1.35248C12.064 1.35248 13.6476 2.94498 13.6476 4.90532C13.6476 6.74041 12.6013 8.50508 11.4008 9.96927C10.2636 11.3562 8.92194 12.5508 8.00601 13.3664C7.94645 13.4194 7.88869 13.4709 7.83291 13.5206C7.64324 13.6899 7.3568 13.6899 7.16713 13.5206C7.11135 13.4709 7.05359 13.4194 6.99403 13.3664C6.0781 12.5508 4.73641 11.3562 3.59926 9.96927C2.39872 8.50508 1.35248 6.74041 1.35248 4.90532Z"
                    fill="currentColor"
                    fillRule="evenodd"
    ...
    `}function Ve(){const e=t=>{const i=t.target.dataset.tabId,a=document.querySelectorAll("[data-tabs] [data-tab-id]");a&&(a[0].dataset.tabId===i?a[0].dataset.tabVisible="true":a[0].dataset.tabVisible="false",a[1].dataset.tabId===i?a[1].dataset.tabVisible="true":a[1].dataset.tabVisible="false")};return o` ${d(2)}
        ...
        ${d(2)}`}const Nt=()=>{const e=_("main"),t=_("[data-tray]"),i=_("[data-tray-overlay]");t.dataset.trayOpen==="false"?(e.setAttribute("inert","true"),i.dataset.trayOverlayOpen="true",t.dataset.trayOpen="true",E(qe(),_("[data-tray]"))):(e.removeAttribute("inert"),i.dataset.trayOverlayOpen="false",t.dataset.trayOpen="false")};function Ue(){return o`
        ${d(1)}
        <button
            id="show-tray"
    ...
    `}function ht(){return o` <p data-font>Docs incoming</p>
        ...
        ${d(1)}
    `}function Ke(e){const t=document.querySelector("article");t!=null&&E(Ye(e),t)}function Ye(e){switch(e){case"reset":return o`${ht()}`;case"tokens":return o`${Ze()}`;case"button":return o`${Ne()}`;case"checkbox":return o`${Pe()}`;case"input":return o`${Le()}`;case"radio":return o`${ze()}`;case"range":return o`${Be()}`;case"select":return o`${De()}`;case"progress":return o`${We()}`;case"switch":return o`${Ge()}`;case"avatar":case"scroller":case"image":return o`${He()}`;case"article":case"hero":return o`${ke()}`;case"icon":return o`${_e()}`;case"action-sheet":return o`${Ie()}`;case"panel":case"card":return;case"group":return o`${Fe()}`;case"list":return o`<p data-font>Check landing</p>
                ${d(4)}`;case"table":return o`${je()}`;case"tabs":return o`${Ve()}`;case"tray":return o`${Ue()}`;case"lobotomized-owl":case"border":case"fit":case"gap":case"gradient":case"hide":case"margin-auto":case"mask":case"overflow":case"padding":case"place":case"print":case"ratio":case"reorder":case"util":return o`${ht()}`;case"font":return o`${Re()}`;case"paper":return o`${Me()}`;default:return o``}}function Qe(){return o`
        <picture>
            <img
                src="https://images.unsplash.com/34/BA1yLjNnQCI1yisIZGEi_2013-07-16_1922_IMG_9873.jpg?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1471&q=80"
            />
    ...
    `}const y={};y.Pic=Qe;y.Content=Xe;y.Avatar=Ot;y.HeadLine=It;y.Line=d;y.Actions=Je;function ti(e,t){return o`
    ...
    `}const S={};S.Content=ti;S.HeadLine=It;S.Line=d;S.Actions=ei;function Pt(e){E(ii(e),document.querySelector("aside"))}function ii(e){const{orientation:t}=g.getState(),i=t==="portrait";return e?o``:o`
        <div
            data-group=""
            data-gap="md"
    ...
    `}function Rt(){E(ai(),document.querySelector("article")),Lt(),Pt(!0)}function ai(){return o`
        <div id="controls">
            <h2></h2>
            <nav></nav>
        </div>
        <div data-group="" data-panel="">${ni()}</div>
    `}function ni(){const{variantPanel:e}=g.getState();switch(e){case"actions":return o` ${S.Content()} ${S.Actions()} `;case"actions-reorder":return o` ${S.Content()}${S.Actions(!0)} `;case"input":return o` ${S.Content(!0,!0)} ${S.Actions()} `;default:return o` ${S.Content()}`}}function ri(){const t=new URLSearchParams(window.location.search).get("snippet"),i=t==="card",a=n=>{const r=n.target.dataset.option;if(t===r)return;const s=new URL(document.location.href);s.searchParams.set("snippet",r),history.pushState({},"",s),r==="card"?Mt():Rt()};return o`
        <div class="subnav bi">
            <button
                data-side="bottom"
                data-nav="group"
                ...
                @click=${{handleEvent:a}}
            >
                ${l({vertices:3,size:45,transforms:"translateX(10px)",fill:i?"var(--red-100)":"currentColor"})}
            </button>
            <button
                data-side="bottom"
                data-nav="group"
                ...
                @click=${{handleEvent:a}}
            >
                ${l({vertices:4,size:45,transforms:"translateX(10px)",fill:i?"currentColor":"var(--red-100)"})}
            </button>
        </div>
    ...
    `}const oi=[{label:"default",value:"currentColor"},{label:"red",value:"var(--red-100)"},{label:"purple",value:"var(--purple-100)"},{label:"gray",value:"var(--gray-300)"}];function si(){E(li(),document.querySelector("section > header div:first-of-type"))}function li(){const e=t=>{const{swatch:i}=t.target.dataset,a={red:"error",purple:"focus",gray:"gray",default:""}[i],n=_("article");n!=null&&(n.classList.remove("error","focus","gray"),a!==""&&n.classList.add(a))};return o`
        <div data-group="flex" data-gap="sm">
            ${oi.map(t=>o`
                    <button
    ...
    `}function Lt(){E(di(),document.querySelector("#controls nav")),E(ci(),document.querySelector("#controls h2"))}function di(){const{variant:e,variantPanel:t,orientation:i}=g.getState(),n=new URLSearchParams(window.location.search).get("snippet"),r=n==="card",s=n==="panel";return o`
        ${ri()} ${r?ft(e):ft(e,!0)}
        ${r?mt(i):mt(i,!0)}
        ${s?gt(t):gt(t,!0)}
    `}function ci(){const t=new URLSearchParams(window.location.search).get("snippet"),i=t==="card"?"content with ratio":"interactive elements";return o` <strong>${`${t}:`}</strong> groups ${i}`}function Mt(){E(zt(),document.querySelector("article")),Lt(),Pt(!1)}function zt(){const{orientation:e}=g.getState();return o` <div
        class="${e==="portrait"?"fix-portrait-card-height":""}"
    >
        <div data-group="" data-card="" data-ratio="${e}">
            ${ui()}
        </div>
    </div>`}function ui(){const{variant:e}=g.getState();switch(e){case"actions":return o` ${y.Content()} ${y.Actions()} `;case"pic":return o` ${y.Pic()}
                <div class="pin-avatar">${y.Avatar()}</div>`;case"pic-content":return o` ${y.Pic()} ${y.Content()} `;case"pic-reorder":return o` ${y.Pic()} ${y.Content(!0)} `;default:return o``}}function pi(){E(vi(),document.querySelector("#search-results-container"))}function vi(){const{suggestions:e}=g.getState();return e.length===0?o``:o`
    ...
    `}g.subscribe(Bt);function hi(){const e=_("#q");e!=null&&(e.value=""),A(g,v.FILTERED,Ct.filtered),A(g,v.SUGGESTIONS,[])}function fi(e){var n;const{filtered:t}=g.getState(),a=((n=e.target)==null?void 0:n.value).replace(/[^a-zA-Z]/g,"").toLowerCase();if(a.length>0){const r=t.filter(s=>s.value.startsWith(a));r.length>0&&(A(g,v.FILTERED,r),A(g,v.SUGGESTIONS,r))}}function Bt(){const{filtered:e}=g.getState(),i=new URLSearchParams(window.location.search).get("snippet");if(pi(),i===null){vt("#controls"),Ee({label:"Featured snippets",snippets:e});return}vt("h1");const a=_("#controls");["card","panel"].includes(i)?(a!=null&&a.classList.add("show"),i==="card"&&Mt(),i==="panel"&&Rt()):(a!=null&&a.classList.remove("show"),Ke(i),["paper"].includes(i)||si())}document.addEventListener("DOMContentLoaded",function(){const e=_("#clear-input");e!=null&&e.addEventListener("click",hi);const t=_("#q");t!=null&&t.addEventListener("input",fi),Bt()});
